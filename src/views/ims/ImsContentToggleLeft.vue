<template>
  <div class="ims-toggle-container">
    <div v-for="(item, index) in options" :key="item.value" class="ims-toggle-item" :class="[
            ...
            itemClass
        ]" :style="{ marginLeft: index === 0 ? '0' : '-30px' }" @click="handleToggle(item.value)">
      <!-- 背景图层 -->
...
import selectedBg from '@/assets/img/ims/content-tab-selected-bg.png';
import unselectedBg from '@/assets/img/ims/content-tab-unselected-bg.png';
